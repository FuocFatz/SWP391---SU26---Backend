...
public class RaceController {
        ...
        @Operation(summary = "Get all races", description = "Retrieves races. Optionally filter by tournamentId, refereeId, or status.")
        @ApiResponse(responseCode = "200", description = "List of races", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Race.class))))
        @GetMapping
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Race found", content = @Content(schema = @Schema(implementation = Race.class))),
        ...
        @ApiResponse(responseCode = "200", description = "Race created successfully", content = @Content(schema = @Schema(implementation = Race.class)))
        @PostMapping
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Race updated successfully", content = @Content(schema = @Schema(implementation = Race.class))),
                        @ApiResponse(responseCode = "400", description = "Race not found", content = @Content)
        })
        @PutMapping("/{id}")
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Status updated", content = @Content(schema = @Schema(implementation = Race.class))),
                        @ApiResponse(responseCode = "400", description = "Race not found", content = @Content)
        })
        ...
        @Operation(summary = "Get race registrations", description = "Retrieves all registrations for a specific race")
        @ApiResponse(responseCode = "200", description = "List of registrations", content = @Content(array = @ArraySchema(schema = @Schema(implementation = RaceEntryResponse.class))))
        ...
        @Operation(summary = "Register a horse for a race", description = "Registers a horse into a race via the race workflow")
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Horse registered successfully", content = @Content(schema = @Schema(implementation = RaceRegistration.class))),
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Race started", content = @Content(schema = @Schema(implementation = Race.class))),
        ...
        @Operation(summary = "Simulate a race", description = "Runs a simulation for the race, optionally for a given duration")
        ...
        @Operation(summary = "Get race results", description = "Retrieves final results for a completed race ordered by finish position")
        @ApiResponse(responseCode = "200", description = "List of race results", content = @Content(array = @ArraySchema(schema = @Schema(implementation = RaceResult.class))))
        ...
        @Operation(summary = "Confirm race results", description = "Referee confirms and records the official race results")
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Results confirmed", content = @Content(array = @ArraySchema(schema = @Schema(implementation = RaceResult.class)))),
        ...
        @Operation(summary = "Get predictions for a race", description = "Retrieves all spectator predictions for a specific race")
        @ApiResponse(responseCode = "200", description = "List of predictions", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Prediction.class))))
        ...
        @Operation(summary = "Create a prediction for a race", description = "Places a spectator prediction on a race via the race workflow")
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Prediction placed successfully", content = @Content(schema = @Schema(implementation = Prediction.class))),
        ...
        @Operation(summary = "Horse leaderboard", description = "Retrieves the overall horse performance leaderboard")
        ...
        @Operation(summary = "Jockey leaderboard", description = "Retrieves the overall jockey performance leaderboard")
