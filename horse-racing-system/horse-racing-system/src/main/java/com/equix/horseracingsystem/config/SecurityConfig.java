        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET,
                                ...
                                "/api/races/*/results", "/api/races/*/simulate",
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/races/*/complete", "/api/races/*/report").hasRole("REFEREE")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/users/role/JOCKEY").hasAnyRole("ADMIN", "HORSE_OWNER")
