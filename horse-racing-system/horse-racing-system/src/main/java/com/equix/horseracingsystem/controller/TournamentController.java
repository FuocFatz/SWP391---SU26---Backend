...
public class TournamentController {
        ...
        @ApiResponse(responseCode = "200", description = "List of tournaments", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Tournament.class))))
        @GetMapping
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Tournament found", content = @Content(schema = @Schema(implementation = Tournament.class))),
        ...
        @ApiResponse(responseCode = "200", description = "Tournament created", content = @Content(schema = @Schema(implementation = Tournament.class)))
        @PostMapping
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Tournament updated", content = @Content(schema = @Schema(implementation = Tournament.class))),
                        @ApiResponse(responseCode = "400", description = "Tournament not found", content = @Content)
        })
        @PutMapping("/{id}")
